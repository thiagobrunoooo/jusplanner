...
6. ESGOTAMENTO PRECOCE (MUITO IMPORTANTE): Se o edital for pequeno e os tópicos acabarem antes da última semana informada (${weeksCount}), NÃO REPITA OS TÓPICOS! Espalhe-os de forma mais lenta ao longo das semanas. Se ainda sobrarem dias vazios nas semanas finais, preencha-os EXCLUSIVAMENTE com a string literal "review". NUNCA duplique ou repita o nome de um tópico que já foi estudado em um dia anterior no cronograma.
