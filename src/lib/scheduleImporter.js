...
5. DESMEMBRAMENTO DE BLOCOS GIGANTES (GRANULARIDADE): É extremamente comum que a banca agrupe muita coisa num único item (ex: "5. Fatos e atos jurídicos: negócios; requisitos; representação; prescrição e decadência"). SE o aluno não tiver horas suficientes para ler tudo isso em um único dia, VOCÊ DEVE QUEBRAR esse blocão em tópicos menores baseando-se nas VÍRGULAS e PONTO-E-VÍRGULAS (;). Exemplo: crie um tópico "Fatos jurídicos e negócios" e outro "Prescrição e decadência".
6. ESGOTAMENTO PRECOCE (MUITO IMPORTANTE): Se o edital for pequeno e os tópicos acabarem antes da última semana informada (${weeksCount}), NÃO REPITA OS TÓPICOS! Espalhe-os de forma mais lenta ao longo das semanas. Se sobrarem dias vazios nas semanas finais, preencha a grade com blocos de revisão específicos por matéria (ex: "Revisão de Direito Penal"). ATENÇÃO: Se você criar uma revisão, VOCÊ DEVE OBRIGATORIAMENTE adicionar esse tópico (ex: "Revisão de Direito Penal") dentro da array de 'topics' da respectiva matéria no JSON, para que o sistema consiga encontrá-lo. NUNCA duplique ou repita o nome de um tópico comum de estudo que já foi alocado em um dia anterior.
7. TÓPICOS INDIVISÍVEIS E MASSIVOS: Se for um tópico único, mas que você sabe que é massivo (ex: "Licitações" puro), fracione anexando " - Parte 1" e " - Parte 2". NUNCA repita exatamente a mesma string de tópico no cronograma.
